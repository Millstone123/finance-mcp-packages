...
import { snapshots } from '@millstone123/finance-market-runtime';
...
input.on('line', line => {
  ...
  if (req.method === 'initialize') return send({ jsonrpc: '2.0', id: req.id, result: { protocolVersion: req.params?.protocolVersion || '2025-06-18', capabilities: { tools: {} }, serverInfo: { name: 'finance-tools', version: '3.1.0' } } });
